...
class ProductsController extends Controller {
    ...
    {
        $products = Products::with("user")->with("catalogs")->get();
...
$catalogs = Catalogs::pluck("name", "id")->prepend('Please select', null);
	    ...
	    return view('admin.products.create', compact("user", "catalogs", "showhide"));
	}
...
$catalogs = Catalogs::pluck("name", "id")->prepend('Please select', null);
		...
		return view('admin.products.edit', compact('products', "user", "catalogs", "showhide"));
	}
