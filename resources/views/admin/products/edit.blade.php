...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('description', old('description',$products->description), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::select('catalogs_id', $catalogs, old('catalogs_id',$products->catalogs_id), array('class'=>'form-control')) !!}
